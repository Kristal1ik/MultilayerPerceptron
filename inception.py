...
class InceptionBlock(Module):
    def __init__(self, c_in, c_1, c_2, c_3):
        ...
        self.c1 = Conv2d(kernel_size=(1, 1), in_channels=c_in, out_channels=c_1)

        self.c5 = Conv2d(kernel_size=(1, 1), in_channels=c_in, out_channels=c_1)
        self.c2 = Conv2d(kernel_size=(3, 3), in_channels=c_1, out_channels=c_2, padding=1)

        self.c6 = Conv2d(kernel_size=(1, 1), in_channels=c_in, out_channels=c_1)
        self.c3 = Conv2d(kernel_size=(5, 5), in_channels=c_1, out_channels=c_3, padding=2)

        self.mp1 = MaxPool2d(kernel_size=(3, 3), stride=1, padding=1)
        self.c4 = Conv2d(kernel_size=(1, 1), in_channels=c_in, out_channels=c_1)
